...
public class TestChromeDevToolsManipulatingNetworkSpeed4g extends Base {
	...
	public void testRunNetworkSpeed4G() throws Exception {
		...
		devTools.send(
				Network.emulateNetworkConditions(false, 100, 20000, 10000, Optional.of(ConnectionType.CELLULAR4G)));
